  ...
  return {
    ...
    controller: ['$scope', function ($scope) {
      ...
      $scope.onClick = function (date) {
        $scope.modal.modalTitle = date.event.title;
        $scope.modal.modalContent = date.event.description;
        $scope.modal.modalWebsite = date.event.website;
        $scope.modal.modalOra = date.event.ora;
